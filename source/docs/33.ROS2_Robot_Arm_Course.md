...
<img src="../_static/media/chapter_33/section_1/media/image2.png" class="common_img" />

<img src="../_static/media/chapter_33/section_1/media/image3.png" class="common_img" />
...
<img src="../_static/media/chapter_33/section_1/media/image4.png" class="common_img" />
...
<img src="../_static/media/chapter_33/section_2/media/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_33/section_2/media/image3.png" class="common_img" />

<img src="../_static/media/chapter_33/section_2/media/image4.png" class="common_img" />
...
<img src="../_static/media/chapter_33/section_2/media/image5.png" class="common_img" />

<img src="../_static/media/chapter_33/section_2/media/image6.png" class="common_img" />
...
<img src="../_static/media/chapter_33/section_6/media/image15.png" class="common_img" />
...
<img src="../_static/media/chapter_33/section_6/media/image21.png" class="common_img" />
...
<img src="../_static/media/chapter_33/section_7/media/image7.png" class="common_img" />
...
<img src="../_static/media/chapter_33/section_7/media/image24.png" class="common_img" />
...
<img src="../_static/media/chapter_33/section_7/media/image30.png" class="common_img" />
...
<img src="../_static/media/chapter_33/section_7/media/image31.png" class="common_img" />
...
<img src="../_static/media/chapter_33/section_7/media/image34.png" class="common_img" />
...
```
cos∠OAP = (l1² + PA² - PO²) / (2 * l1 * PA)
```

```
cos∠PAC = (l2² + PA² - l3²) / (2 * l2 * PA)
```

Angle `∠OAC = arccos(cos∠OAP) + arccos(cos∠PAC)`
...
```
angle∠AOB = arccos(cos∠AOP) + arcsin(sin∠POB)
```
...
```python
	    if abs(cos_OAP) > 1:
            ...
            return Falsexxxxxxxxxx             if abs(cos_OAP) > 1:            print('ERROR:不能构成连杆结构, abs(cos_OAP)为%s > 1' %(abs(cos_OAP)) )            return False# paste source code here.
```
