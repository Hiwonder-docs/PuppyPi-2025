...
(11) Next, upload the command word configuration file. Navigate to the folder [`4. Wake Word Protocol List`]() and locate the spreadsheet titled `Command Phrase and Playback Protocol List V3 – English Template`. Simply drag and drop the file into the upload area on the webpage.
