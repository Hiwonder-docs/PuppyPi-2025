...
(1) Open VNC software, double click <img src="../_static/media/chapter_7/section_1/media/image2.png" class="common_img" /> to open LAB_Tool.
...
| **Zone**                    | **Zone Layout**                                              |
| --------------------------- | ------------------------------------------------------------ |
| Image display zone          | <img src="../_static/media/chapter_7/section_1/media/image4.png" /> |
| Recognition adjustment zone | <img src="../_static/media/chapter_7/section_1/media/image4.png" /> |

- **Image Display Zone**

| **Icon**                                                     | **Function**                                                 |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| <img src="../_static/media/chapter_7/section_1/media/image4.png" /> | At left, it is the original image. At right, it is the processed image. |

- **Recognition Adjustment Zone**

| **Icon**                                                     | **Function**                                                 |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| <img src="../_static/media/chapter_7/section_1/media/image5.png" /> | Used to adjust **L** component of the image. Its function is the same as that of A and B sliders. |
| <img src="../_static/media/chapter_7/section_1/media/image4.png" /> | Select the recognized color to adjust                        |
| <img src="../_static/media/chapter_7/section_1/media/image6.png" /> | Save the adjusted value                                      |
| <img src="../_static/media/chapter_7/section_1/media/image7.png" /> | Add new colors                                               |
...
<img src="../_static/media/chapter_7/section_1/media/image8.png" class="common_img" />
...
<img src="../_static/media/chapter_7/section_1/media/image10.png" class="common_img" />
...
<img src="../_static/media/chapter_7/section_1/media/image12.png" class="common_img" />
...
<img src="../_static/media/chapter_7/section_1/media/image13.png" class="common_img" />

(3) Click **"Save"** buttons to keep the modified data.

<img src="../_static/media/chapter_7/section_1/media/image14.png" class="common_img" />
...
(2) Click <img src="../_static/media/chapter_7/section_2/media/image3.png" style="width:70px" /> to open command line terminal.
...
<img src="../_static/media/chapter_7/section_2/media/image6.png" class="common_img" /> <img src="../_static/media/chapter_7/section_2/media/image7.png" class="common_img" />

### 7.2.4 Program Analysis

[Source Code](https://claude.ai/chat/b20c9aea-d0ec-4144-99d6-bca494208000)

The source code for this program can be found within the Docker container at: [/home/ubuntu/puppypi/src/puppy_standard_functions/scripts/color_detect_demo.py](https://claude.ai/chat/b20c9aea-d0ec-4144-99d6-bca494208000)
...
(1) Based on [**"7.1 Color Threshold Adjustment"**](https://claude.ai/chat/b20c9aea-d0ec-4144-99d6-bca494208000), use LAB_TOOL to add orange and save it.
...
<img src="../_static/media/chapter_7/section_2/media/image24.png" class="common_img" />
...
<img src="../_static/media/chapter_7/section_2/media/image25.png" class="common_img" /> 

<img src="../_static/media/chapter_7/section_2/media/image26.png" class="common_img" /> <img src="../_static/media/chapter_7/section_2/media/image27.png" class="common_img" />
...
<img src="../_static/media/chapter_7/section_2/media/image28.png" class="common_img" />
...
(2) Click <img src="../_static/media/chapter_7/section_5/media/image3.png" style="width:70px" /> to open command line terminal
...
<img src="../_static/media/chapter_7/section_5/media/image5.png" class="common_img" /> <img src="../_static/media/chapter_7/section_5/media/image6.png" class="common_img" />
...
The source code for this program is located in the Docker container at: [/home/ubuntu/puppypi/src/puppy_standard_functions/scripts/color_tracking_demo.py](https://claude.ai/chat/b20c9aea-d0ec-4144-99d6-bca494208000)
...
(2) Click <img src="../_static/media/chapter_7/section_6/media/image3.png" style="width:70px" /> to open command line terminal
...
<img src="../_static/media/chapter_7/section_6/media/image5.png" class="common_img" />

### 7.4.4 Program Analysis

[Source Code](https://claude.ai/chat/b20c9aea-d0ec-4144-99d6-bca494208000)

The source code for this program is located inside the Docker container at: [/home/ubuntu/puppypi/src/puppy_standard_functions/scripts/color_tracking_demo.py](https://claude.ai/chat/b20c9aea-d0ec-4144-99d6-bca494208000)
...
(1) Click <img src="../_static/media/chapter_7/section_6/media/image16.png" style="width:70px" /> to open command line terminal
...
(1) Double click the <img src="../_static/media/chapter_7/section_6/media/image22.png" /> in the system desktop to open color threshold adjustment tool. If the prompt box pops up, just click **"Execute"**.

<img src="../_static/media/chapter_7/section_6/media/image23.png" />

(2) Next, click **"Add"** button.

<img src="../_static/media/chapter_7/section_6/media/image24.png" />

(3) Then enter **"yellow"** in the pop-up interface.

<img src="../_static/media/chapter_7/section_6/media/image25.png" />

(4) Select **"yellow"** in the drop-down menu.

<img src="../_static/media/chapter_7/section_6/media/image26.png" />
...
<img src="../_static/media/chapter_7/section_6/media/image27.png" />

(6) After adjustment, click **"Save"** to keep the data. Then we can close the tool.

<img src="../_static/media/chapter_7/section_6/media/image28.png" />

(7) Click <img src="../_static/media/chapter_7/section_6/media/image16.png" /> to open command line terminal
...
<img src="../_static/media/chapter_7/section_6/media/image30.png" />

(9) According to the steps in [**"7.4.5 Modify Default Recognition Color"**](https://claude.ai/chat/b20c9aea-d0ec-4144-99d6-bca494208000), modify the default recognition color as yellow.
...
(2) Click <img src="../_static/media/chapter_7/section_3/media/image3.png" style="width:70px" /> to open command line terminal.
...
<img src="../_static/media/chapter_7/section_3/media/image6.png" class="common_img" /> <img src="../_static/media/chapter_7/section_3/media/image7.png" class="common_img" />

### 7.5.4 Program Analysis

[Source Code](https://claude.ai/chat/b20c9aea-d0ec-4144-99d6-bca494208000)

The source code of this program is stored in the Docker container: [/home/ubuntu/puppypi/src/puppy_standard_functions/scripts/apriltag_detect_demo.py](https://claude.ai/chat/b20c9aea-d0ec-4144-99d6-bca494208000)
...
(2) Click <img src="../_static/media/chapter_7/section_7/media/image3.png" style="width:70px"/> to open command line terminal.
...
<img src="../_static/media/chapter_7/section_7/media/image6.png" class="common_img" /> <img src="../_static/media/chapter_7/section_7/media/image7.png" class="common_img" />

### 7.6.4 Program Analysis

[Source Code](https://claude.ai/chat/b20c9aea-d0ec-4144-99d6-bca494208000)

The source code of this program is stored in the Docker container: [/home/ubuntu/puppypi/src/puppy_standard_functions/scripts/apriltag_tracking_demo.py](https://claude.ai/chat/b20c9aea-d0ec-4144-99d6-bca494208000)
...
(2) Click <img src="../_static/media/chapter_7/section_8/media/image3.png" style="width:70px" /> to open command line terminal.
...
(1) Click <img src="../_static/media/chapter_7/section_8/media/image3.png" style="width:70px" /> to open command line terminal.
...
(2) Click <img src="../_static/media/chapter_7/section_4/media/image3.png" style="width:70px" /> to open command line terminal.
...
<img src="../_static/media/chapter_7/section_4/media/image6.png" class="common_img" /> <img src="../_static/media/chapter_7/section_4/media/image7.png" class="common_img" />

### 7.8.4 Program Analysis

[Source Code](https://claude.ai/chat/b20c9aea-d0ec-4144-99d6-bca494208000)

The source code of this program is stored in [/home/ubuntu/puppypi/src/puppy_standard_functions/scripts/apriltag_AR_demo.py](https://claude.ai/chat/b20c9aea-d0ec-4144-99d6-bca494208000)
...
(1) Click <img src="../_static/media/chapter_7/section_4/media/image21.png" style="width:70px" /> at upper left corner to open command line terminal.
