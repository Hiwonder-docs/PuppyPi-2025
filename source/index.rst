...
.. toctree::
   ...
   docs/8.ROS1_AI_Stair_Recognition_and_Negotiating_Course.md
   docs/9.ROS1_AI_Auto_Tracking_and_Shooting_Course.md
   docs/10.ROS1_AI_Vision_Line_Following_Course.md
   docs/11.ROS1_MediaPipe_Human_Robot_Interaction_Courses.md
   ...
   docs/22.ROS2_Simulation_Course.md
   docs/23.ROS2_AI_Vision_and_Tracking_Course.md
   docs/24.ROS2_AI_Stair_Recognition_and_Negotiating_Course.md
   docs/25.ROS2_AI_Auto_Tracking_and_Shooting_Course.md
   docs/26.ROS2_AI_Vision_Line_Following_Course.md
   docs/27.ROS2_MediaPipe_Human_Robot_Interaction_Courses.md
   docs/28.ROS2_AI_Voice_Interaction_Courses.md
   docs/29.ROS2_Sensor_Development_Course.md
   docs/30.ROS2_Lidar_Course.md
   docs/31.ROS2_SLAM_Mapping_Course.md
   docs/32.ROS2_Autonomous_Navigation_Course.md
